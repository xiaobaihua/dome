 ...
 */
public class YWBDrawler extends BreadthCrawler {
	static int l = 0;
	 ...
	 */
	public
	YWBDrawler(String crawlPath, boolean autoParse) {
	...
	public void visit(Page page, CrawlDatums next) {
		...
		if (page.code() == 301 || page.code() == 302) {
			...
			if (Pattern.matches(".*120ask.com/question/[0-9].*", s) && bean.getThreeUrl().size() < 3) {
